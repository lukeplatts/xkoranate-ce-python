...
[GitHub repo](https://github.com/lukeplatts/xkoranate-ce-python/issues/new/choose) —
there are separate templates for bug reports and feature requests. Check the
[roadmap](https://github.com/lukeplatts/xkoranate-ce-python/blob/main/ROADMAP.md)
...
that's a bug — please [report it](https://github.com/lukeplatts/xkoranate-ce-python/issues/new?template=bug_report.yml).
